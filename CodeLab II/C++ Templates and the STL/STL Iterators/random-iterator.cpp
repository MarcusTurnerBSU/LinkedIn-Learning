//random access iterator is the most complete iterator
//this is used toaccess any element at any position in a container. It also offers functionality of a C pointer
#include <iostream>
#include <vector>
using namespace std;
