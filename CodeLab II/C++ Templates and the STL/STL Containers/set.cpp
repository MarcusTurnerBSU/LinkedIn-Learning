//a set is a container holds a sorted set of elements - set class hold only unique elements
//multiset class allows duplicates
//unordered set does not sort elements and instead provides hashed keys for faster access
#include <iostream>
#include <string>
#include <set>
