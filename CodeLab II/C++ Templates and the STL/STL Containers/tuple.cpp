...
template<typename T>
//tuple can be many different sizes - working with a 3 tuple
//have to have specific print functions 
void print3tuple(T t) {
    auto tsz = tuple_size<decltype(t)>::value;
    if (tsz != 3) return;
    //template function requires element specifier in template parameters
