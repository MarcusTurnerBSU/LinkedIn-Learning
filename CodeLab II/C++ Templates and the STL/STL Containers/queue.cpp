...
//a queue is a container adaptor adapts an underlying container into a first in first out queue
template <typename T>
...
int main()
{
    ...
    //the deque is optimisedfor this sort of use
    deque<int> l1 = { 1, 2, 3, 4, 5 };
    queue<int, deque<int>> q1(l1);    // constructor copies to new list
    report_queue(q1);
