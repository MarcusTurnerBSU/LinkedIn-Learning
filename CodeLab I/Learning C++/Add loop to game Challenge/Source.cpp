...
int main()
{
    ...
    do {
        ...
        while (gameOver == false)
        {
            ...
            /* while (chipsTaken > maxPerTurn && chipsTaken > chipsInPile)
            Fixed error with players able to take more chips
            Really close written slightly wrong and just need to add greater than 1 to chipsInPile
        ...
        /*right idea but wrong, cout prints before end of the loop and as userChoice is a 'char'.
        The user's input should follow
        }
        while (playAgain)
